...
echo ""
echo "[3/7] Starting Information Service..."
...
echo ""
echo "[4/7] Starting Identify Service..."
...
echo ""
echo "[6/7] Starting Product Service..."
...
echo ""
echo "[7/7] Starting Payment Service..."
cd "$PROJECT_DIR/payment"
mvn spring-boot:run > /tmp/payment.log 2>&1 &
PAYMENT_PID=$!
wait_for_service 9898 "Payment Service"
...
echo "  Payment:          http://localhost:9898/swagger-ui.html"
echo ""
echo "Process IDs:"
